sap.ui.define([
	...
	return Opa5.extend("MT.SMT_Managment.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["MT/SMT_Managment/localService/mockserver"], function (mockserver) {
